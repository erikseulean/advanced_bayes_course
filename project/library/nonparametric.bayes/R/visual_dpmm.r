...
#' Sequentially generate draws from a Dirichlet process mixture model, by showing
#' step by step the iterations taken. 
    ...
    for (sample in 1: n) {
        ...
        plot(x,
            ...
            main=paste("N = ", toString(n),
                ...
                ", #clusters = ", toString(length(unique(cluster_assignments))),sep="")
        )
